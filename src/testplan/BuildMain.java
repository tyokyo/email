...
public class BuildMain {
	...
	public static String testPlanBuffer(ArrayList<String> plansDirs){
		...
		for (String dir : plansDirs) {
			String testplan = String.format("<testplans dir=\"%s\" includes=\"*.jmx\" />",dir);
	...
	public static void main(String[] args) {
		...
		//String buildxmlTemplate="D:\\soft\\Jmeter\\Auto\\build.xml";
		String buildxmlTemplate=args[0];
		String testCaseFolder=args[1];
		String buildXml=args[2];
		
		/*String buildxmlTemplate="D:\\soft\\Jmeter\\Auto\\build.xml";
		String testCaseFolder="D:\\soft\\Jmeter";
		String buildXml="D:\\soft\\Jmeter\\Auto\\build_ext.xml";*/
		
		
		ArrayList<String> folders= new ArrayList<String>();
		//getfolders(folders, "D:\\soft\\Jmeter");
